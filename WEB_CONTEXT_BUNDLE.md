...
```json
{
  ...
  "problem_contract": {
    ...
    "aliases": [
      "wikipedia:wikipedia-9898d7f8d80ed0e8"
    ],
    "allowed_axioms": [
    ...
    "domain": {
      "description": "Draft source observation in Number theory, Diophantine equations; domain extraction is unresolved.",
      "objects": [
    ...
    "problem_id": "problem:wikipedia-9898d7f8d80ed0e8",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "wikipedia-9898d7f8d80ed0e8",
        "url": "https://en.wikipedia.org/wiki/Sums_of_three_cubes"
      }
    ],
    "statement": {
      "language": "en",
      "text": "Which integers can be written as the sum of three perfect cubes ?",
      "version": 1
    },
    "title": "Which integers can be written as the sum of three perfect cubes ?",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "d4aef1839e4ff32682926fd9dd21b5cf93d91f17e90f350a0cc13dc12c1d19ec"
}
```
